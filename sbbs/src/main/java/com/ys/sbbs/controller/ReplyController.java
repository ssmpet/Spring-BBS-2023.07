...
public class ReplyController {
	...
	@PostMapping("/write")
	public String writeProc(int bid, String uid, String f, String q, String comment, HttpSession session) {
		...
		return "redirect:/board/detail/" + bid + "/" + uid + "?option=DNI&f=" + f + "&q=" + q;
	}
